...
export default function VideoKYCPage() {
  ...
  // ✅ FIX 1: Read 'id' because your dynamic routing folder path is named [id]
  ...
  const startCall = async () => {
    ...
    try {
      ...
      // ✅ FIX 2: Validate environmental variables safely
      ...
      // ✅ FIX 3: Sanitize the roomId to follow strict alphanumeric requirements from Zego servers
      ...
      // ✅ FIX 4: Corrected compilation block keyword syntax
      setLoading(false);
    }
  };
